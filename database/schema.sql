-- ===========================================
-- Schema MySQL - Loja Crianças e Cia
-- ===========================================
-- Execute no phpMyAdmin ou MySQL da Hostinger

CREATE DATABASE IF NOT EXISTS loja_criancasecia CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE loja_criancasecia;
